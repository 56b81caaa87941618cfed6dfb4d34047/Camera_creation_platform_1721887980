...
*/
Vue.component("simple_footer_component_1721887982", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            PixelPro: Crafting Visual Masterpieces
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Unleash your creativity with PixelPro, the intuitive app that empowers you to design and build high-quality cameras tailored to your unique vision. From concept to reality, we provide the tools and expertise to bring your imaging ideas to life.
                    </div>
                </div>
            </div>
        </footer> 
